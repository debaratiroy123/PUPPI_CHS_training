...
void CreateTreeForPileupJetIdTraining()
{
  ...
  TFile *outf   = TFile::Open("Signal_Tr2016_forCHS.root","RECREATE");
  ...
  */
  ...
  for(int iev=0;iev<5000;iev++) {
    double progress = 10.0*iev/(1.0*5000);
  ...
  cout<<"0.0  - 2.5 signal: "<<trOUT1->GetEntries()<<endl;
  cout<<"2.5  - 2.75 signal: "<<trOUT3->GetEntries()<<endl;
  cout<<"2.75 - 3.0 signal: "<< trOUT5->GetEntries()<<endl;
  cout<<"3.0  - 5.0 signal: "<< trOUT7->GetEntries()<<endl; 
